...
class FeatureEngineering: 
    ...
    def build_all_stats(self, stats_df, upcoming_stats, odds_df, upcoming_odds):
        ...
        scraped_columns = [
            ...
            'red_age', 'blue_age', 'event_location', 'title_fight'
        ]
        ...
        empty_df['event_date'] = pd.to_datetime(empty_df['event_date'], format="%Y-%m-%d")
        ...
        merged_df.to_csv(r'C:\Users\jcmar\my_files\SportsBetting\data\stats_odds_merged.csv', index=False)
