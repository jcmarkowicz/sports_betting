...
# files to save ALL scraped upcoming, timestamped by nearest fight date 
...
# folder for stats/odds data per event 
upcoming_events_folder =  BASE_DIR / "Data" / "upcoming_events" / "event_dfs" 
...
if __name__ == "__main__":
    ...
    if get_missing_stats:
        ...
        commit_if_changed(f'{stats_history_file_string}_{date_today}.csv', f'Updating Stats Scraped History for {date_today}')
        ...
        commit_if_changed(f'{odds_history_file_string}_{date_today}.csv', f'Updating Odds Scraped History for {date_today}')
