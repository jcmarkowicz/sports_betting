...
import pandas as pd 
from ufc_betting.DataPipeline.FeatureEngineering.BuildFeatures.final_feats_df import non_rolling_stats
from ufc_betting.DataPipeline.FeatureEngineering.BuildFeatures.fight_time_feats import single_event_features, upcoming_event_features
from ufc_betting.DataPipeline.FeatureEngineering.BuildFeatures.rolling_stats import apply_rolling_stats
from ufc_betting.DataPipeline.FeatureEngineering.BuildFeatures.odds_features import build_odds_features
from ufc_betting.DataPipeline.FeatureEngineering.BuildFeatures.feature_functions import count_fav_dog
...
class FeatureEngineering: 
    ...
    def build_all_stats(self, stats_df, upcoming_stats, odds_df, upcoming_odds, ignore_upcoming=False):
        ...
        total_odds.to_csv(settings.data_dir / 'features_test_files/all_odds_features.csv', index=False)
        ...
        total_df.to_csv(settings.data_dir / 'features_test_files/new_combined.csv', index=False)
