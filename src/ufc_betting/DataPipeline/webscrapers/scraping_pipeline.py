...
from ufc_betting.DataPipeline.webscrapers.odds_scraper import get_fighter_odds
from ufc_betting.DataPipeline.webscrapers.stats_scraper import scrape_ufc
